...
st.set_page_config(page_title="Pharma Q&A Generator", page_icon="💊")
...
def start_scheduler():
    ...
    scheduler.add_job(scheduled_job, 'cron', day_of_week='tue', hour=15, minute=45, timezone="Asia/Kolkata")
    # Start the scheduler
    scheduler.start()
